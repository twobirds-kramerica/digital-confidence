...
**Files bundled:** opendyslexic-regular.woff2

## Licence

OpenDyslexic is distributed under the **SIL Open Font License, Version 1.1**.

The font was created to increase readability for readers with dyslexia.
It is based on Bitstream Vera Sans (Copyright 2003 Bitstream, Inc.) and
incorporates original modifications by Abelardo Gonzalez.
