...
(function () {
      ...
      '<div class="nl-widget">',
        ...
        '<div class="nl-body">',
          ...
          '<form class="nl-form" novalidate>',
            ...
            '</div>',
            '<p class="nl-error" style="display:none;color:#c62828;font-size:1rem;margin-top:.35rem">' + t('Please enter a valid email address.', 'Veuillez entrer une adresse courriel valide.') + '</p>',
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.nl-fine{font-size:1rem;color:var(--color-text-light,#50505F);margin:.45rem 0 0;}',
