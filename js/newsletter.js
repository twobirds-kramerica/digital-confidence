...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.nl-desc{font-size:.88rem;color:#555;line-height:1.55;margin:0 0 .75rem;}',
      '.nl-input-row{display:flex;gap:.45rem;flex-wrap:wrap;}',
      '.nl-email{flex:1;min-width:180px;padding:.5rem .75rem;border:1px solid #ccc;border-radius:8px;font-size:.9rem;font-family:inherit;color:var(--color-text,#1a1a1a);background:var(--color-bg,#fff);}',
      '.nl-email:focus{outline:2px solid #1565C0;border-color:#1565C0;}',
      '.nl-submit{padding:.5rem 1.1rem;background:#1565C0;color:#fff;border:none;border-radius:8px;font-size:.9rem;font-weight:700;cursor:pointer;white-space:nowrap;}',
      '.nl-submit:hover{background:#0d47a1;}',
      '.nl-fine{font-size:.76rem;color:#999;margin:.45rem 0 0;}',
