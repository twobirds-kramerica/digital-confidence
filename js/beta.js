...
(function () {
  ...
  var T = IS_FR ? {
    ...
    formLabel: "Seulement si vous voulez : se souvenir de moi",
    emailLabel: "Votre courriel (vous pouvez laisser vide)",
    ...
    videoNote: "Seulement si vous le voulez. Rien ne joue tant que vous n'appuyez pas sur lecture.",
    ...
    formLabel: "Only if you like: remember me next time",
    emailLabel: "Your email (you can leave this blank)",
    ...
    videoNote: "Only if you would like to. Nothing plays until you press play.",
